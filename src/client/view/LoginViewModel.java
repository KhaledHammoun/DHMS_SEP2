...
public class LoginViewModel
{
  ...
  public LoginViewModel(Login loginModel) {
  ...
  public void login()
  {
    ...
    {
       loginUser =  new LoginUser(username.getValue(),
          password.getValue(),AccessType.MANAGER );

    }
    else if(doctorProperty.getValue())
    {
       loginUser =  new LoginUser(username.getValue(),
          password.getValue(),AccessType.DOCTOR );

    }
    else if(nurseProperty.getValue())
    {
       loginUser =  new LoginUser(username.getValue(),
          password.getValue(),AccessType.NURSE );
  ...
  public void successLogin(AccessType type)
  {
    ...
    {
      errorLabel.setValue("You have no access!");
      username.setValue("");
      password.setValue("");
    }
